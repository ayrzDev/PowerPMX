...
use pocketmine\item\component\AllowOffHandComponent;
use pocketmine\item\component\ArmorComponent;
use pocketmine\item\component\CanDestroyInCreativeComponent;
use pocketmine\item\component\CooldownComponent;
use pocketmine\item\component\CreativeCategoryComponent;
use pocketmine\item\component\CreativeGroupComponent;
use pocketmine\item\component\DisplayNameComponent;
use pocketmine\item\component\DurabilityComponent;
use pocketmine\item\component\FoodComponent;
use pocketmine\item\component\FuelComponent;
use pocketmine\item\component\HandEquippedComponent;
use pocketmine\item\component\IconComponent;
use pocketmine\item\component\ItemComponent;
use pocketmine\item\component\MaxStackSizeComponent;
use pocketmine\item\component\ProjectileComponent;
use pocketmine\item\component\RenderOffsetsComponent;
use pocketmine\item\component\ThrowableComponent;
use pocketmine\item\component\UseAnimationComponent;
use pocketmine\item\component\UseDurationComponent;
use pocketmine\item\component\WearableComponent;
...
trait ItemComponentsTrait
{
	...
	public function getComponents(): CompoundTag
	{
		...
		foreach ($this->components as $component) {
			$tag = CustomNBT::getTagType($component->getValue());
			if ($tag === null) {
	...
	public function addIcon(string $texture): void
	{
		$this->addComponent(new IconComponent($texture));
	}

	public function addCreativeCategory(CreativeInventoryInfo $creativeInfo): void
	{
		$this->addComponent(new CreativeCategoryComponent($creativeInfo));
	}

	/**
	 * Adds a creative group component.
	 */
	public function addCreativeGroup(CreativeInventoryInfo $creativeInfo): void
	{
		$this->addComponent(new CreativeGroupComponent($creativeInfo));
	}

	/**
	 * Adds a can destroy in creative component.
	 */
	public function addCanDestroyInCreative(): void
	{
		$this->addComponent(new CanDestroyInCreativeComponent());
	}

	/**
	 * Adds a max stack size component.
	 */
	public function addMaxStackSize(int $size): void
	{
		$this->addComponent(new MaxStackSizeComponent($size));
	}

	/**
	 * Adds an armor component.
	 */
	public function addArmorComponent(int $defensePoints): void
	{
		$this->addComponent(new ArmorComponent($defensePoints));
	}

	/**
	 * Adds a wearable component.
	 */
	public function addWearableComponent(string $slot): void
	{
		$this->addComponent(new WearableComponent($slot));
	}

	/**
	 * Adds a food component.
	 */
	public function addFoodComponent(bool $requiresHunger): void
	{
		$this->addComponent(new FoodComponent($requiresHunger));
	}

	/**
	 * Adds a use animation component.
	 */
	public function addUseAnimationComponent(string $animation): void
	{
		$this->addComponent(new UseAnimationComponent($animation));
	}

	/**
	 * Adds a durability component.
	 */
	public function addDurabilityComponent(int $maxDurability): void
	{
		$this->addComponent(new DurabilityComponent($maxDurability));
	}

	/**
	 * Adds a projectile component.
	 */
	public function addProjectileComponent(string $type): void
	{
		$this->addComponent(new ProjectileComponent($type));
	}

	/**
	 * Adds a throwable component.
	 */
	public function addThrowableComponent(bool $isThrowable): void
	{
		$this->addComponent(new ThrowableComponent($isThrowable));
	}

	/**
	 * Adds a display name component.
	 */
	public function addName(string $displayName): void
	{
		$this->addComponent(new DisplayNameComponent($displayName));
	}

	/**
	 * Adds a fuel component.
	 */
	public function addFuelComponent(int $fuelTime): void
	{
		$this->addComponent(new FuelComponent($fuelTime));
	}

	/**
	 * Adds a render offsets component.
	 */
	public function addRenderOffsetsComponent(int $width, int $height, bool $handEquipped = false): void
	{
		$this->addComponent(new RenderOffsetsComponent($width, $height, $handEquipped));
	}

	/**
	 * Adds a hand equipped component.
	 */
	public function addHandEquippedComponent(bool $handEquipped): void
	{
		$this->addComponent(new HandEquippedComponent($handEquipped));
	}

	/**
	 * Adds an allow off hand component.
	 */
	public function addAllowOffHandComponent(bool $offHand = true): void
	{
		$this->addComponent(new AllowOffHandComponent($offHand));
	}

	/**
	 * Adds a cooldown component.
	 */
	public function addCooldownComponent(float $duration, string $category = ""): void
	{
		$this->addComponent(new CooldownComponent($category !== "" ? $category : $this->getName(), $duration));
	}

	/**
	 * Adds a use duration component.
	 */
	public function addUseDurationComponent(int $ticks): void
	{
		$this->addComponent(new UseDurationComponent($ticks));
	}
}
